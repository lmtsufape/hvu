...
const ClinicaMedicaPDF = ({ ficha, animal, tutor, medicoLogado }) => {
    ...
    return (
        <Document>
            <Page size="A4" style={styles.page}>
                <Text style={styles.header}>Ficha Clínica Médica</Text>
                ...
                <View style={styles.subsection}>
                    ...
                    <View style={styles.row}><Text style={styles.label}>Vermifugação:</Text><Text style={styles.value}>{ficha.vermifugacaoDetalhes?.vermifugacao === 'Sim' ? `${ficha.vermifugacaoDetalhes.produto || ''} em ${moment(ficha.vermifugacaoDetalhes.data).format('DD/MM/YYYY')}` : 'Não'}</Text></View>
                    <View style={styles.row}><Text style={styles.label}>Observações:</Text><Text style={styles.value}>{ficha.vermifugacaoDetalhes?.observacoes || 'N/A'}</Text></View>
...
export default ClinicaMedicaPDF;
