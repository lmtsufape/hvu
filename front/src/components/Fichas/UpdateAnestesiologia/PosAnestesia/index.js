...
export default function PosAnestesia({
  ...
  const createInitialData = () => timePoints.map(time => ({
    tempo: time,
    Temperatura: "",
    FC: "",
    FR: "",
  ...
  useEffect(() => {
    ...
    if (savedData) {
      try {
        ...
        console.error("Erro ao ler tabela do storage", e);
      }
    }
  }, []);
  ...
  useEffect(() => {
    setFormData(prev => ({
      ...
      pos: { 
        ...
        farmacoPosAnestesico: farmacoPosAnestesico,
        parametros: data
      }
    }));
      ...
      <div className={styles.boxBorder}>
        ...
        <div className="row align-items-center mb-3">
          ...
          <div className="col-md-9">
            ...
            <div className="d-flex align-items-center flex-wrap">
              {["Sim", "Não"].map((opt) => (
                <label key={opt} className="me-4 d-inline-flex align-items-center mb-1">
                  <input
                    type="radio"
        ...
        <div className={styles.colum}>
                ...
                <tr key={idx}>
                  <td>
                    <input
                      ...
                      value={row.farmaco}
                      disabled={isReadOnly}
                      onChange={(e) => handleFarmacoPosChange(idx, "farmaco", e.target.value)}
                    />
                  </td>
                  <td>
                    <input
                      ...
                      value={row.dose}
                      disabled={isReadOnly}
                      onChange={(e) => handleFarmacoPosChange(idx, "dose", e.target.value)}
                    />
                  </td>
                  <td>
                    <input
                      ...
                      value={row.via}
                      disabled={isReadOnly}
                      onChange={(e) => handleFarmacoPosChange(idx, "via", e.target.value)}
                    />
                  </td>
                </tr>
              ))}
          ...
          <div className={styles.bolha_container}>
            <div className={styles.bolha} onClick={addFarmacoRow}>+</div>
            <div className={`${styles.bolha} ${styles.bolha_remover_linha}`} onClick={removerUltimaFarmacoRow}>-</div>
          </div>
        </div>

        <div className="row mb-3">
          <div className="col-md-6">
            <label className="form-label fw-medium">Número da sonda endotraqueal</label>
            <input
              type="text"
              className="form-control"
          ...
          <div className="col-md-6">
            <label className="form-label fw-medium">Fluidoterapia</label>
            <input
              type="text"
              className="form-control"
        ...
        <div className={styles.column}>
                ...
                <tr key={idx}>
                  <td>
                    <input
                      ...
                      value={row.farmaco}
                      disabled={isReadOnly}
                      onChange={e => handleFarmacoPosAnestesicoChange(idx, "farmaco", e.target.value)}
                    />
                  </td>
                  <td>
                    <input
                      ...
                      value={row.dose}
                      disabled={isReadOnly}
                      onChange={e => handleFarmacoPosAnestesicoChange(idx, "dose", e.target.value)}
                    />
                  </td>
                  <td>
                    <input
                      ...
                      value={row.via}
                      disabled={isReadOnly}
                      onChange={e => handleFarmacoPosAnestesicoChange(idx, "via", e.target.value)}
                    />
                  </td>
                  <td>
                    <input
                      ...
                      value={row.hora}
                      disabled={isReadOnly}
                      onChange={e => handleFarmacoPosAnestesicoChange(idx, "hora", e.target.value)}
                    />
                  </td>
                </tr>
              ))}
          ...
          <div className={styles.bolha_container}>
            <div className={styles.bolha} onClick={addFarmacoPosAnestesicoRow}>+</div>
            <div className={`${styles.bolha} ${styles.bolha_remover_linha}`} onClick={removerUltimaFarmacoPosAnestesicoRow}>-</div>
          </div>
        </div>
        ...
        <label htmlFor="pos-plantonistas" className="form-label mb-0 lb-0 fw-medium mt-3">
