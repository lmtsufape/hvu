...
function ClinicaMedicaSilvestresSteps() {
  ...
  const handleSubmit = async () => {
    ...
    "Vermifugação": {
      "Vermifugação": formData.vermifugacaoDetalhes.vermifugacao,
      "Produto": formData.vermifugacaoDetalhes.produto,
      "Data": formData.vermifugacaoDetalhes.data
    },

    "Ectoparasitas": {
      "Ectoparasitas": formData.ectoparasitosDetalhes.ectoparasitos,
      "Produto": formData.ectoparasitosDetalhes.produto,
    ...
    "Avaliação Geral": formData.fisicogeral,
